...
// javascript не може завершити функцію, поки не будуть виконані всі внутрішні функції, при вершому виконані буде викликано два функції fib, 
    кожна з них викличе по 2 фунції зному і так далі. Якщо не помиляюсь, то тут буде залежність 2 в степені n. Для 45 це дуже багато. Тому в 
рекурсивних функціях є обмеження і якщо можливо, краще через цикл порахувати значення.
